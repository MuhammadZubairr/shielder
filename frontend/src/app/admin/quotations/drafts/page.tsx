    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <Link href="/admin/quotations/create" className="flex items-center gap-2 px-4 py-2.5 bg-[#FF6B35] text-white rounded-xl font-bold text-sm shadow-lg shadow-[#FF6B35]/20 hover:bg-[#FF5722] transition-colors">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {loading ? (
                                ...
                                <tr><td colSpan={7} className="px-5 py-16 text-center">
                                    ...
                                    <Link href="/admin/quotations/create" className="text-shielder-primary text-sm font-bold hover:underline mt-2 block">Create one →</Link>
                                </td></tr>
                                ...
                                <tr key={q.id} className="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-5 py-4">
                                        <div className="flex items-center gap-1">
                                            <Link href={`/admin/quotations/${q.id}`} className="p-1.5 text-gray-400 hover:text-shielder-secondary hover:bg-shielder-secondary/5 rounded-lg transition-all"><Eye size={15} /></Link>
                                            <Link href={`/admin/quotations/${q.id}/edit`} className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all"><Edit3 size={15} /></Link>
